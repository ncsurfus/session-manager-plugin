...
import (
	...
	"github.com/ncsurfus/session-manager-plugin/src/jsonutil"
	"github.com/ncsurfus/session-manager-plugin/src/log"
	"github.com/ncsurfus/session-manager-plugin/src/sdkutil"
	"github.com/ncsurfus/session-manager-plugin/src/sessionmanagerplugin/session"
	_ "github.com/ncsurfus/session-manager-plugin/src/sessionmanagerplugin/session/portsession"
	_ "github.com/ncsurfus/session-manager-plugin/src/sessionmanagerplugin/session/shellsession"
	"github.com/ncsurfus/session-manager-plugin/src/ssmclicommands/utils"
